...
var resArray = [
	...
	{
		Name: 'AM/AC',
		Text: 'Welcome to the Academy Stores QuickBase Application.\nPlease take a moment to register yourself with QuickBase before continuing by clicking on the link below.\nPlease keep in mind that your login information will be your current Walmart email address (replaced for privacy) and the password will be what you choose to enter while registering for QuickBase. (Please note QuickBase does not support Single Sign On).\nRegards,\nAcademy Team'
	},
	{
		Name: 'ADM/Fac1',
